...
public class SignUp extends AppCompatActivity {
    ...
    MaterialEditText edtId, edtNama, edtPass;
    Button btnSignUp;
            ...
            public void onClick(View v) {
                ...
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            mDialog.dismiss();
                            Toast.makeText(SignUp.this, "ID sudah teregistrasi!", Toast.LENGTH_SHORT).show();

                        }
                        else
                        {
                            mDialog.dismiss();
                            User user = new User(edtNama.getText().toString(),edtPass.getText().toString());
